...
public class GrammarBot{
    ...
    public static void main() throws TwitterException, InterruptedException{
        ...
        int tweetCount = 567; //starting at this number as tweets were already on the account
        StatusUpdate lastStatus = null;
        ...
        try {
            while(true){
                ...
                if (!statusUpdate.equals(lastStatus)){
            ...
            StatusUpdate statusUpdate = new StatusUpdate("Hey @bradyafr! Something went wrong with my code and I couldn't tweet, fix my code!");
            Status status = twitter.updateStatus(statusUpdate);
        }
    }
}
